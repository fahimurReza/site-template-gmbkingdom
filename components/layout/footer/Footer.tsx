  ...
  return (
    <main className="bg-brand-teal">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-10 gap-10 lg:gap-12 base-padding py-12 md:py-16">
        ...
        <div className="mt-4 sm:mt-0 col-span-1 sm:col-span-2 lg:col-span-4 text-white/90">
        ...
        <div className="mt-2 sm:mt-0 col-span-1 sm:col-span-2 lg:col-span-3 text-white/70">
          <GoogleMap />
        </div>
      </div>
